...
$bancos = PDO::getAvailableDrivers();
    ...
    if (post('send')):
        ...
        if ($base != ''):
            if ($banco == 'sqlite'):
                $model = '<'.'?'.'php'.NL;
                //$model.="\t".'$this->dsntype=1;'.NL;
                $model .= "\t".'$this->dsn=\''.$banco.':'.$base.'\';';
            else:
                $model = '<'.'?'.'php'.NL;
                //$model.="\t".'$this->dsntype=1;'.NL;
                $model .= "\t".'$this->dsn=\''.$banco.'://'.$usuario;
            ...
            try {
                ...
                $control = '<'.'?'.'php'.NL.
                            'use Oraculum\Model;'.NL.
                            'use Oraculum\Request;'.NL.
                            ...
                            "\t".'$grid=new Oraculum\Datagrid($regs);'.NL.NL.
