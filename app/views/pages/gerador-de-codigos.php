<?php
    ...
    $bancos = Oraculum\Register::get('bancos');
    $nomebanco = Oraculum\Register::get('nomebanco');
    $model = Oraculum\Register::get('model');
    $arquivo = Oraculum\Register::get('arquivo');
    $control = Oraculum\Register::get('control');
    $view = Oraculum\Register::get('view');
    $viewlistar = Oraculum\Register::get('viewlistar');
    $msg = Oraculum\Register::get('msg');
 ?>
