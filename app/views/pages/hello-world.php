<?php
    Oraculum\Register::set('titulo', 'Suporte');
 ?>
<div id="content">
    <h1>Hello World</h1>
<p>
...
<p>A fun&ccedil;&atilde;o <strong>loadView</strong> carrega a view com o nome <em>helloworld</em>, logo, voc&ecirc; deve criar um arquivo <strong>helloworld.php</strong> na pasta das views (como padr&atilde;o est&aacute; localizada em views/pages mas o caminho tamb&eacute;m pode ser alterado)</p>
