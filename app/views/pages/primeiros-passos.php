<?php Oraculum\Register::set('titulo', 'Primeiros Passos'); ?>
<div id="content">
...
<a href="https://oraculum-on.github.io/">https://oraculum-on.github.io/</a><br />
<br />
Os requisitos para
...
&eacute; chamada<br />
<br />
<pre style="margin:auto; text-align:left; width:80%;"><strong>&lt;IfModule mod_rewrite.c&gt;</strong>
  <strong>RewriteEngine</strong> On
  # Determina a base de reescrita
  <strong>RewriteBase</strong> /oraculum
  # Verifica se a url nao corresponde a um arquivo existente
  <strong>RewriteCond</strong> %{REQUEST_FILENAME} !-f
  # Verifica se a url nao corresponde a um diretorio existente
  <strong>RewriteCond</strong> %{REQUEST_FILENAME} !-d
  <strong>RewriteRule</strong> .([a-zA-Z0-9]+)?$ index.php
<strong>&lt;/IfModule&gt;</strong></pre><br /> <br />
<p>
